 ...
 */
class ColoredVertexEx(id: Any, numColors: Int, initialColor: Int, isFixed: Boolean = false) extends DataGraphVertexEx[Any, Int, Any, Int](id, initialColor) {
 ...
 */
object VertexColoringEx extends App {
  val graph = new GraphBuilder[Any, Int].build
  graph.addVertex(new ColoredVertexEx(1, 2, 1))
  graph.addVertex(new ColoredVertexEx(2, 2, 1))
  graph.addVertex(new ColoredVertexEx(3, 2, 1))
