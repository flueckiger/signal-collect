 ...
 */
class PathEx(t: Any) extends OptionalSignalEdge(t) {
  /**
 ...
 */
class LocationEx(vertexId: Any, initialState: Option[Int] = None) extends DataFlowVertexEx[Any, Option[Int], Any, Int](vertexId, initialState) {
  type Signal = Int
  /**
...
object SSSPEx extends App {
  val graph = new GraphBuilder[Any, Int].build
  graph.addVertex(new LocationEx(1, Some(0)))
  graph.addVertex(new LocationEx(2))
  graph.addVertex(new LocationEx(3))
  graph.addVertex(new LocationEx(4))
  graph.addVertex(new LocationEx(5))
  graph.addVertex(new LocationEx(6))
  graph.addEdge(1, new PathEx(2))
  graph.addEdge(2, new PathEx(3))
  graph.addEdge(3, new PathEx(4))
  graph.addEdge(1, new PathEx(5))
  graph.addEdge(4, new PathEx(6))
  graph.addEdge(5, new PathEx(6))
